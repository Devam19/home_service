...
class User_Register(View):
    ...
    def post(self,request):
        ...
        if password == cpassword:
            ...
            users.objects.create(admin=new_user, Address=address, gender=gender, contact_number=contact_number,profile_pic=profile_pics,age=age,citizenship=citizen,language_prefered=language,covid_19_vaccinated=covid)
...
class bookservice(LoginRequiredMixin, View):
    ...
    def post(self,request,id):
        ...
        return HttpResponseRedirect('https://rzp.io/l/GLAb26D')
...
class AddServices(LoginRequiredMixin, View):
    ...
    def post(self,request):
        ...
        ServiceCatogarys.objects.create(Name=Name,Description=Description,img=img,price=price)
