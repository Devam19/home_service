...
class users(models.Model):
    ...
    citizenship = models.CharField(max_length = 150,default='')
    language_prefered = models.CharField(max_length = 150,default='')
    covid_19_vaccinated = models.BooleanField(default=False)
